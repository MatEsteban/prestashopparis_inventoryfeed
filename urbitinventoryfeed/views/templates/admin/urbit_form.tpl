...
{block name="input"}
    ...
    {elseif $input.type == 'urbit_token'}
        ...
        <div class="form-group">
            <a href="/index.php?fc=module&module=urbitinventoryfeed&controller=feed&token={$input.token}" id="generate-token-button" class="btn btn-default" target="_blank">Get the feed</a>
        </div>
    {else}
        {$smarty.block.parent}
    {/if}
